create table User
(
UserCode varchar(20) not null comment '用户编码，唯一',
...
(
CommID varchar(20) not null comment '商品编码，唯一',
Commname varchar(40) not null comment '商品名称',
Price varchar(40) not null comment '单价',
Count Int	not null comment '数量',
EffectStartDate	    Date  not null comment '有效起期',
...
(
OrderMainID varchar(20) not null comment '商品编码，唯一',
...
(
SerialNo varchar(30) not null comment '订单流水号，唯一',
